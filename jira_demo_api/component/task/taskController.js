...
exports.addTask=(req,res)=>{
   ...
   // console.log('upload',file.name);
    ...
    var qry="insert into task( `title`, `description`,`attechment`, `uid`, `pid`) values('"+ title +"','"+ desc +"','"+ file +"','"+ uid +"',"+ pid +")";
    console.log(qry);
...
exports.updateTask=(req,res)=>{
    ...
    console.log('req.body',req.body);
    let qry="update task set title='"+ title +"',description='"+ desc +"',uid='"+ uid +"' where pid='"+ pid +"'";
    console.log(qry);
